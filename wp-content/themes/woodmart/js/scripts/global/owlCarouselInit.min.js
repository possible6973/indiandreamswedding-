! function(o) {
    ...
    }), o.each(["frontend/element_ready/wd_products.default", "frontend/element_ready/wd_products_tabs.default", "frontend/element_ready/wd_product_categories.default", "frontend/element_ready/wd_products_brands.default", "frontend/element_ready/wd_blog.default", "frontend/element_ready/wd_portfolio.default", "frontend/element_ready/wd_images_gallery.default", "frontend/element_ready/wd_product_categories.default", "frontend/element_ready/wd_banner_carousel.default", "frontend/element_ready/wd_infobox_carousel.default", "frontend/element_ready/wd_instagram.default", "frontend/element_ready/wd_testimonials.default", "frontend/element_ready/wd_nested_carousel.default"], function(e, a) {
        woodmartThemeModule.wdElementorAddAction(a, function() {
            woodmartThemeModule.owlCarouselInit()
        })
    }), woodmartThemeModule.owlCarouselInit = function() {
        function e(e) {
            var a, d = e.find(".owl-carousel");

            function t() {
                var e = d.find(".owl-item.active").find(".wd-slide").attr("id"),
                    e = d.find('[id="' + e + '"]');
                d.find(".owl-item.pseudo-active").removeClass("pseudo-active"), e.each(function() {
                    var e = o(this);
                    e.parent().hasClass("active") || e.parent().addClass("pseudo-active")
                })
            }
            woodmartThemeModule.windowWidth <= 1024 && e.hasClass("disable-owl-mobile") || d.hasClass("owl-loaded") || (a = {
                ...
                responsive: {
                    ...
                    769: {
                        items: e.data("tablet_landscape") ? e.data("tablet_landscape") : 1
                    },
                    577: {
                        items: e.data("tablet") ? e.data("tablet") : 1
                    },
                    0: {
                        items: e.data("mobile") ? e.data("mobile") : 1
                    }
                },
                ...
                rewind: !0
            }, e.data("sliding_speed") && (a.smartSpeed = e.data("sliding_speed"), a.dragEndSpeed = e.data("sliding_speed")), e.data("animation") && (a.animateOut = e.data("animation"), a.mouseDrag = !0), e.data("content_animation") && (t(), a.onTranslated = function() {
                t()
            }), woodmartThemeModule.$window.on("vc_js", function() {
                d.trigger("refresh.owl.carousel")
            }), d.find("link").appendTo("head"), d.owlCarousel(a), "yes" === e.data("autoheight") && d.imagesLoaded(function() {
                d.trigger("refresh.owl.carousel")
            }))
        }
        o("[data-owl-carousel]:not(.scroll-init):not(.wd-slider-wrapper)").each(function() {
            e(o(this))
        }), void 0 !== o.fn.waypoint && o("[data-owl-carousel].scroll-init:not(.wd-slider-wrapper)").waypoint(function() {
