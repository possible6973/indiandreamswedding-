! function(n) {
    woodmartThemeModule.$document.on("wdCloseMobileMenu", function() {
        ...
        var e = woodmartThemeModule.$body,
            ...
            a = n(".wd-close-side");
        d.append('<span class="wd-nav-opener"></span>'), o.on("click", ".wd-nav-opener", function(e) {
            e.preventDefault();
            e = n(this).parent();
            ...
            var e = n(this),
                o = e.data("menu");
            e.hasClass("wd-active") || (e.parent().find(".wd-active").removeClass("wd-active"), e.addClass("wd-active"), n(".wd-nav-mobile").removeClass("wd-active"), n(".mobile-" + o + "-menu").addClass("wd-active"), woodmartThemeModule.$document.trigger("wood-images-loaded"))
        }), e.on("click", ".wd-header-mobile-nav > a", function(e) {
            e.preventDefault(), o.hasClass("wd-opened") ? woodmartThemeModule.closeMobileNavigation() : (n(this).parent().addClass("wd-opened"), o.addClass("wd-opened"), a.addClass("wd-close-side-opened"), woodmartThemeModule.$document.trigger("wood-images-loaded"))
