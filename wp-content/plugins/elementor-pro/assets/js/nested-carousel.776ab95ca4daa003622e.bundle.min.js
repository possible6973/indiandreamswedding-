            ...
            class NestedCarousel extends elementorModules.frontend.handlers.CarouselBase {
                ...
                getSwiperSettings() {
                    ...
                    return elementorFrontend.isEditMode() && (delete e.autoplay, e.loop = !1, e.noSwipingSelector = ".swiper-slide > .e-con .elementor-element"), "yes" === t.arrows && (e.navigation = {
                        prevEl: s ? `${i} .elementor-swiper-button-next` : `${i} .elementor-swiper-button-prev`,
                        nextEl: s ? `${i} .elementor-swiper-button-prev` : `${i} .elementor-swiper-button-next`
                    }), this.applySwipeOptions(e), e
                }
                async onInit() {
                    this.wrapSlideContent(), super.onInit(...arguments), this.ranElementHandlers = !1
                }
                async initSwiper() {
                ...
                wrapSlideContent() {
                    ...
                    this.findElement(`${e.selectors.slidesWrapper} > .e-con`).each((function() {
                        const n = jQuery(this),
                            ...
                            o = s.find(`${e.selectors.slidesWrapper} > .${t}:nth-child(${i})`);
                        r || o.append(n), i++
                    }))
                }
                ...
                async linkContainer(e) {
                    ...
                    if (t.model.get("id") === this.$element.data("id")) {
                        ...
                        void 0 !== t && t.appendChild(o), this.shouldHideNavButtons(r, e), this.updateIndexValues(e);
                        const l = this.swiper && !this.swiper.destroyed,
                            a = e.length > 1;
                        !l && a ? await this.initSwiper() : l && !a && this.swiper.destroy(!0), this.updateListeners()
                    }
                }
                updateListeners() {
